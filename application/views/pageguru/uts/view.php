			...
			<tbody>
				<tr>
					...
					foreach ($data as $value) { ?>
						...
						<td><input name="nilai2<?= $no ?>" id="nilai2<?= $no ?>" maxlength="3" max="100" type="text" value="<?= $value['UTSTRNIL2'] ?>"></td>
						...
						$("#uts<?= $no ?>").keypress(function(event) {
							if (event.keyCode == 13) {
								...
								$.ajax({
									...
									data: "nilai=" + nilai + "&nilai2=" + nilai2 + "&nis=" + nis + "&idjadwal=" + idjadwal + "&id_krs=" + id_krs + "&NMKLSTRJDK=" + NMKLSTRJDK + "&id_mapel=" + id_mapel + "&idnilai=" + idnilai,
									cache: false,
