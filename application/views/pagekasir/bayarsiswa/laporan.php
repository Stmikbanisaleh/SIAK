...
// // print_r(json_encode($cari1));exit;
  ...
  $row = $this->db->query("SELECT sum(nominal) as lain_lain FROM tarif_berlaku WHERE ThnMasuk='$v_thnmasuk' AND kodesekolah='$v_kodesekolah' AND Kodejnsbayar NOT IN('KGT','SRG','SPP','GDG')")->row();
