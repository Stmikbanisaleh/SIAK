...
class Buk extends CI_Controller
{
    ...
    public function insertd($datee , $datee2){
        $kdo = 1;
        ...
        $f_bln = $v_bln;
        $s_bln = ltrim($f_bln, '0');
        $query="SELECT * FROM detail_akuntansi where no_akuntansi not in (select no_bukti from transaksi_buk) and dk = 'D' and tgl_input between '".$datee."' AND '".$datee2." ' ";   
    ...
    public function proses(){
        ...
        $f_bln = $v_bln;
        $s_bln = ltrim($f_bln, '0');
        $query="SELECT * FROM detail_akuntansi where no_akuntansi not in (select no_bukti from transaksi_buk) and dk = 'K' and tgl_input between '".$datee."' AND '".$datee2." ' ";   
        $hasil = $this->model_buk->dyn_query($query)->result_array();
            $no=1;
            foreach ($hasil as $r) {
                $sql="INSERT INTO transaksi_buk(
